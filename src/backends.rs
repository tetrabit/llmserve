...
impl Backend {
    ...
    pub fn can_serve_local_gguf(&self) -> bool {
        matches!(
            self,
            Backend::LlamaServer | Backend::Vllm | Backend::KoboldCpp | Backend::LocalAi | Backend::Ollama | Backend::Lemonade
        )
    }
    ...
    pub fn local_serve_reason(&self) -> Option<&'static str> {
        match self {
            Backend::LlamaServer | Backend::KoboldCpp | Backend::MlxLm | Backend::LocalAi | Backend::Lemonade | Backend::Ollama => None,
...
impl DetectedBackend {
    pub fn can_launch(&self) -> bool {
        match self.backend {
            ...
            Backend::Lemonade | Backend::FastFlowLm => self.binary_path.is_some(),
        }
    }
